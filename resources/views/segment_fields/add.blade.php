...
<section class="w3-padding">
    ...
    <h2>Add Segment Field Template</h2>
    ...
    <form method="post" action="/console/segment_fields/add" novalidate class="w3-margin-bottom">
        ...
        <div class="w3-margin-bottom">
            ...
            <input type="field_name" name="field_name" id="field_name" value="{{old('field_name')}}" required>
        ...
        <div class="w3-margin-bottom">
            ...
            <input type="field_data_type" name="field_data_type" id="field_data_type" value="{{old('field_data_type')}}" required>
        ...
        <button type="submit" class="w3-button w3-green">Add Segment Field Template</button>
